    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            ...
            case Config.CREATE:
                    ...
                    gestionnaireArticles.createArticle((String) request.getParameter("title"), (String) request.getParameter("permalink"), (String) request.getParameter("intro"),
                            (String) request.getParameter("content"), gestionnaireArticles.findSectionByTitle(request.getParameter("section")));
