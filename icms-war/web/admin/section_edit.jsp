...
<html>
    <head>
        ...
        <title>Admin > Section > Edit</title>
    ...
    <body>
        ...
        <div id="tinyMCE">
            <form method="post" action="/icms-war/admin/sections">
                ...
                <input type="hidden" id="idSection" name="idSection" value="<c:out value="${requestScope['section'].id}" />" />

                <label for="section">Cat&eacute;gorie :</label>
                <select name="category" title="category" id="category">
                    <option value="<c:out value="${requestScope['section'].myCategory.permalink}" />"><c:out value="${requestScope['section'].myCategory.title}" /></option>
